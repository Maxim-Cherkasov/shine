  ...
  return (
    <div className="text-center space-y-4 my-12">
      <div className="flex justify-center gap-2">
        ...
        <Badge variant="secondary" className="bg-pink-100">
          <Gift className="w-4 h-4 mr-1" />С сюрприз-подарком
        </Badge>
      </div>
      ...
      <div className="max-w-2xl mx-auto p-6 border-2 border-pink-200 rounded-[20px] bg-white/50 backdrop-blur-sm shadow-lg">
        <p className="text-gray-600 text-2xl">
          Дорогие Девочки!!! В преддверии Новогоднего праздника, хочу предложить
          Вам свою Акцию "СИЯЙ" (с сюрпризом подарком!!!) За чисто символическую
          цену (с выездом на дом).
        </p>
      </div>
    </div>
  );
